...
//互补模式，独立占空比和相位，固定主周期，边沿对齐
	...
	PTPER  = PWM_PTPER;  //FCY/2/FPWM-1;//1250;    	//SET PWM PERIOD ONPRIMARY TIME BASE
	...
	DTR1   =  DTR2  =  DTR3 = PWM_DeadTime;//87;//34;			////SET DEAD TIME VALUES     15--1.7US
	ALTDTR1 = ALTDTR2 = ALTDTR3  = PWM_DeadTime;//87;//34;
