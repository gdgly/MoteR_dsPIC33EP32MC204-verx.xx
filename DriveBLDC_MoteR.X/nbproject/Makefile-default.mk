...
# Source Files
SOURCEFILES=../Application/Application.c ../Application/RampGenerator/RampGenerator.c ../Common/Delay/Delay.c ../Drivers/GPIO/GPIO.c ../Drivers/InputCapture/InputCapture.c ../Drivers/ADC/ADC.c ../Drivers/Timer/Timer.c ../Drivers/PWM/MCPWM.c ../Main/Main.c ../MotorControl/SpeedController/SpeedController.c ../MotorControl/Algorithm/svm.c ../MotorControl/CurrentController/CurrentController.c ../MotorControl/Braking/DCInjection.c ../MotorControl/CurrentController/CurrentLimit.c ../MotorControl/PIController/pi.c
...
${OBJECTDIR}/_ext/1693421727/Application.o: ../Application/Application.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../Application/Application.c  -o ${OBJECTDIR}/_ext/1693421727/Application.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1693421727/Application.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -mno-eds-warn  -omf=elf -O0 -I".." -I"../Drivers/GPIO" -I"../Drivers/InputCapture" -I"../Application/RampGenerator" -I"../MotorControl/PIController" -I"../MotorControl/Algorithm" -I"../MotorControl/SpeedController" -I"../DMCI" -I"../Common/Delay" -I"../Common/Extern" -I"../Common/UserDefinition" -I"../Drivers/PWM" -I"../Middleware/ParameterDatabase" -I"../Middleware/CommunicationStack" -I"../MotorControl/Braking" -I"../MotorControl/CurrentController" -I"../Application" -msmart-io=1 -Wall -msfr-warn=off -mno-eds-warn
...
dist/${CND_CONF}/${IMAGE_TYPE}/DriveBLDC_MoteR.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/DriveBLDC_MoteR.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--library-path="..",--no-force-link,--smart-io,-Map="${DISTDIR}/DriveBLDC750W.X.${IMAGE_TYPE}.map",--report-mem,--no-local-stack$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/DriveBLDC_MoteR.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/DriveBLDC_MoteR.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--library-path="..",--no-force-link,--smart-io,-Map="${DISTDIR}/DriveBLDC750W.X.${IMAGE_TYPE}.map",--report-mem,--no-local-stack$(MP_EXTRA_LD_POST) 
